...
2. **Build and publish.** goreleaser builds the `devpulse-site` and `devpulse-import` binaries and a ko-built container image and pushes the
...
pre-1.0 (`v0.51.71` at the time of writing). Until 1.0, minor versions may
