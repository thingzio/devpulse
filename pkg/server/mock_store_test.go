...
type mockStore struct {
	...
	getContributorCompositionFn func(ctx context.Context, org, repo, entity *string, days int) (*data.ContributorComposition, error)
...
func (m *mockStore) GetContributorComposition(ctx context.Context, org, repo, entity *string, days int) (*data.ContributorComposition, error) {
	if m.getContributorCompositionFn != nil {
		return m.getContributorCompositionFn(ctx, org, repo, entity, days)
	}
	return nil, nil
}
