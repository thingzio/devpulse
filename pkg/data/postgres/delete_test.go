...
func TestDeleteRepoData_NilDB(t *testing.T) {
	...
	s := &Store{db: nil}
	_, err := s.DeleteRepoData(ctx, "org", "repo")
...
func TestDeleteRepoData_EmptyDB(t *testing.T) {
	ctx := context.Background()
	store := setupTestDB(t)
	result, err := store.DeleteRepoData(ctx, "org", "repo")
...
func TestDeleteRepoData_WithData(t *testing.T) {
	...
	// Delete myorg/myrepo
	result, err := store.DeleteRepoData(ctx, "myorg", "myrepo")
	require.NoError(t, err)
...
func TestDeleteRepoData_EmptyParams(t *testing.T) {
	...
	_, err := store.DeleteRepoData(ctx, "", "repo")
	assert.Error(t, err)

	_, err = store.DeleteRepoData(ctx, "org", "")
	assert.Error(t, err)
}
